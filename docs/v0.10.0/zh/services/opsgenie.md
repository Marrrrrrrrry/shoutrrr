...
:::caution 服务即将终止
Atlassian 已宣布 Opsgenie 终止计划：2025 年 6 月 4 日停止新销售，服务（含本服务使用的 Alert API）
将于 **2027 年 4 月 5 日** 关停。存量客户应在该日期前迁移到 Jira Service Management 或其他告警服务。
参见 [Atlassian 迁移指南](https://www.atlassian.com/software/opsgenie/migrate)。
:::

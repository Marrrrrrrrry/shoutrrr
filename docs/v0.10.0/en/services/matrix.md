...
:::info Usage of the `title` parameter
...
*  __User__ - Username or empty when using access token  
  Default: *empty*  
  URL part: <code class="service-url">matrix://<strong>user</strong>:password@host/</code>  
*  __Password__ - Password or access token (**Required**)  
  URL part: <code class="service-url">matrix://user:<strong>password</strong>@host/</code>  
*  __Host__ (**Required**)  
  URL part: <code class="service-url">matrix://user:password@<strong>host</strong>/</code>  
### Query/Param Props

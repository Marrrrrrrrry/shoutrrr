...
:::caution End of life
Atlassian has announced the end of Opsgenie: new sales stopped on June 4, 2025 and the
service (including the Alert API used here) shuts down on **April 5, 2027**.
Existing customers should migrate to Jira Service Management or another alerting service
before that date. See [Atlassian's migration guide](https://www.atlassian.com/software/opsgenie/migrate).
:::

...
*  __Token__ (**Required**)  
  URL part: <code class="service-url">telegram://<strong>token</strong>@telegram/</code>  
### Query/Param Props

Props can be either supplied using the params argument, or through the URL using  
`?key=value&key=value` etc.

*  __Chats__ - Chat IDs or Channel names (using @channel-name) (**Required**)  
  Aliases: `channels`  
...
:::tip
You can use the `marrrrrrrrry/shoutrrr` image in docker to run it without download/installing the `shoutrrr` CLI using:
```
...
The bot should be constantly online, unless it's usage exceeds the free tier on GCP. It's source is available at [github.com/marrrrrrrrry/shoutrrrbot](https://github.com/marrrrrrrrry/shoutrrrbot).
